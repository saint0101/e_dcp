...
from app import app
from config_bd import config_local
...
@app.route('/')
@app.route('/edcp/api/v0/descriptions')
...
def create_user():
    ...
    try:
        ...
        # Encode le mot de passe avant de l'insérer dans la base de données generate_password_hash(user_data['passwd'], method='sha256')
