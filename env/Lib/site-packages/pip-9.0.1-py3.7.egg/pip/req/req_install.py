...
class InstallRequirement(object):
    ...
    def _correct_build_location(self):
        ...
        For some requirements.txt (e.g. a path to a directory), the name of the
    ...
    def check_if_exists(self):
        ...
        if self.req is None:
            return False
        try:
            # get_distribution() will resolve the entire list of requirements.txt
