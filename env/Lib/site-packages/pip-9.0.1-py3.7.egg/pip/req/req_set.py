...
class DistAbstraction(object):
    ...
    The requirements.txt for anything installable are as follows:
     ...
     - we must be able to generate a list of run-time dependencies
       ...
       all requirements.txt are available' rule - neither of which are
       desirable).
     - for packages with setup requirements.txt, we must also be able
       to determine their requirements.txt without installing additional
...
class RequirementSet(object):
    ...
    def add_requirement(self, install_req, parent_req_name=None,
        ...
        :param parent_req_name: The name of the requirement that needed this
            added. The name is used because when multiple unnamed requirements.txt
        ...
        :return: Additional requirements.txt to scan. That is either [] if
        ...
        # This check has to come after we filter requirements.txt with the
        # environment markers.
    ...
    def _check_skip_installed(self, req_to_install, finder):
        ...
        if req_to_install.satisfied_by:
            ...
            if upgrade_allowed:
                # For link based requirements.txt we have to pull the
    ...
    def _prepare_file(self,
        ...
        """Prepare a single requirements.txt file.
        ...
        with indent_log():
            ...
            if req_to_install.editable:
                ...
                if os.path.exists(
                    ...
                    raise PreviousBuildDirError(
                        "pip can't proceed with requirements.txt '%s' due to a"
                ...
                # requirements.txt we have and raise some more informative errors
                ...
                if require_hashes:
                    ...
                    # unhashable requirements.txt, complaining that there's no
                    # hash provided.
                    if is_vcs_url(link):
            ...
            if not self.has_requirement(req_to_install.name):
                # 'unnamed' requirements.txt will get added here
                self.add_requirement(req_to_install, None)

            if not ignore_dependencies:
                if (req_to_install.extras):
                    logger.debug(
                        "Installing extra requirements.txt: %r",
    ...
    def _to_install(self):
        ...
        The installation order is topological - requirements.txt are installed
