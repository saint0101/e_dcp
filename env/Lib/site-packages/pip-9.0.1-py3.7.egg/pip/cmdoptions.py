...
skip_requirements_regex = partial(
    Option,
    # A regex to be used to skip requirements.txt
    '--skip-requirements.txt-regex',
...
def requirements():
    return Option(
        ...
        default=[],
        metavar='file',
        help='Install from the given requirements.txt file. '
        'This option can be used multiple times.')
...
require_hashes = partial(
    ...
    help='Require a hash to check each requirement against, for '
         ...
         'requirements.txt file has a --hash option.')
